...
export class VideoGallariesComponent {
  ...
  videos = signal<VideoItem[]>([
    { title: 'PASTE VIDEO TITLE 1', event: 'PASTE EVENT NAME 1', source: 'youtube', id: '1yi5B_89Cao' },
    { title: 'PASTE VIDEO TITLE 2', event: 'PASTE EVENT NAME 2', source: 'youtube', id: 'PGrxbp4t6BQ' },
    { title: 'PASTE VIDEO TITLE 3', event: 'PASTE EVENT NAME 3', source: 'youtube', id: '9J0_gKq3i5c' },
    { title: 'PASTE VIDEO TITLE 4', event: 'PASTE EVENT NAME 4', source: 'youtube', id: 'cprDT3_lfmk' },

    { title: 'PASTE VIDEO TITLE 1', event: 'PASTE EVENT NAME 1', source: 'youtube', id: 'vwEYiKA8b1c' },
    { title: 'PASTE VIDEO TITLE 2', event: 'PASTE EVENT NAME 2', source: 'youtube', id: 'MBbsTz4A0-Y' },

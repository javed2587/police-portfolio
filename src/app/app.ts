...
@Component({
  selector: 'app-root',
  imports: [NavbarComponent, HeroComponent, DutiesComponent, VideoGallariesComponent, PosterGallriesComponent, ContactComponent, MediaShowcaseComponent, SkillsComponent, LeadershipComponent],
